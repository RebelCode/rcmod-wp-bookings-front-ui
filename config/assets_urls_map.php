...
return [
    ...
    'wizard_ui/dist/app.min.js' => 'https://unpkg.com/@rebelcode/booking-wizard@0.1.3/dist/js/app.min',
    'wizard_ui/assets/main.js'  => plugins_url(RC_BOOKINGS_FRONT_UI_MODULE_RELATIVE_DIR . '/dist/main.js', EDDBK_FILE),
